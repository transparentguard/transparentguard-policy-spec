 ...
 */
function buildProvenance(job, modelManifest, hyperparameters = {}, tags = {}) {
    return {
 ...
 */
function signProvenance(provenance, privateKeyPem) {
 ...
 */
function verifyProvenance(provenance, publicKeyPem) {
