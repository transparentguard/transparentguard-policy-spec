      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full mt-12 mb-24">
        ...
        <div className="grid grid-cols-3 gap-0 border border-border">
          <div className="border-r border-border p-4 h-24 flex items-center justify-center cursor-pointer hover:bg-foreground/5 transition-colors group">
            <span className="text-[14px] group-hover:opacity-100 opacity-70">upload //</span>
          </div>
          <textarea 
            placeholder="type //"
            className="border-r border-border p-4 h-24 bg-transparent outline-none resize-none placeholder:text-foreground/70 hover:bg-foreground/5 transition-colors text-[14px] focus:bg-foreground/5 focus:placeholder:opacity-40"
          />
          <button type="button" className="p-4 h-24 flex items-center justify-center hover:bg-foreground/5 transition-colors group">
            <span className="text-[14px] group-hover:opacity-100 opacity-70">speak //</span>
          </button>
        </div>

        <textarea 
          placeholder="add context — assumptions, what you're stuck on..."
          className="w-full bg-transparent border border-border p-5 h-32 resize-none outline-none placeholder:text-foreground/40 text-[14px] hover:bg-foreground/5 transition-colors focus:bg-foreground/5"
        />
