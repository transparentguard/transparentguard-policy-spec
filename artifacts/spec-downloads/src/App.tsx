      ...
      <motion.div custom={0.5} variants={fadeUp} initial="hidden" animate="show" className="mb-20">
        <div className="border-2 border-foreground p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-5">
          <p className="font-mono text-sm text-foreground leading-relaxed max-w-xl">
            Your next security review is asking about AI policy. This is your answer. Start your 14-day trial and be in production before the end of the day.
          </p>
          <a href="https://transparentguard.com"
            ...
            Get API Key <ArrowDownToLine size={15} strokeWidth={2.5} />
          </a>
        </div>
      </motion.div>
        ...
        <motion.section custom={6} variants={fadeUp} initial="hidden" animate="show">
          <div className="border-2 border-foreground p-8 md:p-12 flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div className="max-w-lg">
              <div className="font-mono text-xs font-bold text-foreground mb-3">14-Day Free Trial</div>
              <h3 className="text-2xl md:text-3xl font-extrabold tracking-tighter uppercase mb-3">Close the compliance gap today.</h3>
              <p className="font-mono text-sm text-foreground leading-relaxed">
                Most teams lose their first enterprise deal to an AI compliance gap they could have closed in an afternoon. A trial key gives you ML-grade classifiers, pre-built HIPAA and GDPR rule libraries, and audit logs your compliance team can actually sign off on.
              </p>
            </div>
            <div className="shrink-0">
              <a href="https://transparentguard.com"
                ...
                Get API Key <ArrowDownToLine size={18} strokeWidth={2.5} />
              </a>
            </div>
          </div>
        </motion.section>
      ...
      outcome: allowed_with_modifications`} label="policies/production.yaml" />
            ...
            <div className="border-2 border-foreground p-5">
              ...
              <p className="font-mono text-xs text-foreground mt-2">
                Sections 1–29 · Schema · 7 example policies · JSON Schema (tps-v1.json)
              </p>
            </div>
          </DocSection>
